...
import {setColumnVisibility} from "../../lib/column";
import {hasUserRole} from "../../lib/user";
import {initApp} from "../../utils/initApp";

initApp();

export const funcSetColumnVisibility = onCall({}, async (request) => {
	if (!request.auth) {
	...
	await setColumnVisibility(data.column, data.visibility);
